...
class MyMessageTableViewCell: UITableViewCell {
    ...
    private enum Metrics {
        ...
        static let messageViewLeadingInset: CGFloat = 56
        static let messageViewTrailingInset: CGFloat = 16
        
        static let avatarHeightWidth: CGFloat = 32
        
        static let messageBackgroundViewTrailingInset: CGFloat = -8
...
private extension MyMessageTableViewCell {
    ...
    func configureConstraints() {
        messageView.snp.makeConstraints { make in
            ...
            make.leading.greaterThanOrEqualToSuperview().inset(Metrics.messageViewLeadingInset)
        ...
        messageBackgroundView.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(avatar.snp.leading).inset(Metrics.messageBackgroundViewTrailingInset)
            make.bottom.equalTo(emptyViewForIndent.snp.top)
        }
